...
#if NET5_0
            _dynamicModule.SetCustomAttribute(new CustomAttributeBuilder(typeof(System.Runtime.CompilerServices.SkipLocalsInitAttribute).GetConstructor(Type.EmptyTypes), new object[0]));
#endif
