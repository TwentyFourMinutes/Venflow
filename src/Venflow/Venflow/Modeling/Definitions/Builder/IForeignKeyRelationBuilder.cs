...
namespace Venflow.Modeling.Definitions.Builder
{
        ...
        where TRelation : class
    {
        ...
        IRelationConfigurationBuilder<TEntity, TRelation> UsingForeignKey<TKey>(Expression<Func<TEntity, TKey>> navigationProperty);
        ...
        /// <typeparam name="TKey">The type of the foreign key.</typeparam>
        /// <param name="navigationProperty">A lambda expression representing the foreign key property (post => post.BlogId).</param>
        IRelationConfigurationBuilder<TEntity, TRelation> UsingForeignKey<TKey>(Expression<Func<TRelation, TKey>> navigationProperty);
    }
}
