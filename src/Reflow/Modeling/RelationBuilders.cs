namespace Reflow.Modeling
{
        ...
        where TRelation : class
    {
        IForeignKeyRelationBuilder<TEntity, TRelation> WithOne(
            Func<TRelation, TEntity> navigationProperty
        );
    }

    public interface IRequiredMultiRightRelationBuilder<TEntity, TRelation>
    ...
    public interface INotRequiredMultiRightRelationBuilder<TEntity, TRelation>
        : IMultiRightRelationBuilder<TEntity, TRelation>,
    ...
    {
        IForeignKeyRelationBuilder<TEntity, TRelation> WithMany(
            Func<TRelation, IList<TEntity>> navigationProperty
        );
    }

    public interface ILeftRelationBuilder<TEntity> where TEntity : class, new()
    {
        INotRequiredMultiRightRelationBuilder<TEntity, TRelation> HasOne<TRelation>(
            Func<TEntity, TRelation> navigationProperty
        ) where TRelation : class;
        IRequiredMultiRightRelationBuilder<TEntity, TRelation> HasOne<TRelation>()
            where TRelation : class;
        INotRequiredSingleRightRelationBuilder<TEntity, TRelation> HasMany<TRelation>(
